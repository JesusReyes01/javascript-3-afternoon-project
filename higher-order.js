...
let bobsTotal = purchases.filter(({owner}) => owner === 'Bob')
.reduce((runningTotal, curElement, curIndex, wholeArray) => runningTotal + curElement.price, 0)



// let bobsTotal  = purchases.reduce((runningTotal, curElement, curIndex, wholeArray) => {
  // return runningTotal + curElement.price; }, 0);
